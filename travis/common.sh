...
function fix_esp8266_boards()
{
  ...
  sed -i.bak 's/generic.menu.eesz.4M3M/generic/g' $file
  sed -i.bak 's/nodemcu.menu.eesz.4M3M/nodemcu/g' $file
  sed -i.bak 's/nodemcuv2.menu.eesz.4M3M/nodemcuv2/g' $file
  sed -i.bak 's/d1_mini.menu.eesz.4M3M/d1_mini/g' $file
  sed -i.bak 's/esp8285.menu.eesz.1M128/esp8285/g' $file
